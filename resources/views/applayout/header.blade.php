        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li><a class="nav-link nav-link-label" href="{{ route('frontend.packages') }}"><i class="ficon ft-user"></i></a>
                        
                    </li>
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                            href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">{{Auth::user() ? Auth::user()->name : 'Error while laoding'}}</span><span class="avatar avatar-online"><img
                        ...
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{ route('profile.edit') }}"><i
                                    ...
                                    class="ft-clipboard"></i> Todo</a><a class="dropdown-item" href="#"><i
